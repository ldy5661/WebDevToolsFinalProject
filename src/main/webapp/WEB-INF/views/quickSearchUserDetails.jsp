      ...
      <td>
         <table width="600" cellpadding="0" cellspacing="0">
            ...
            <tr>
               <td width="350" bgColor="#D0CFC4">
                  <table cellpadding="0" width="350" cellspacing="0" >
                     <tr>
                        <td align="center"><img src='${quickSearchUser.fileLocation}'></td>
                     </tr>
               ...
               <td height="100%" bgColor="#F8F8F2">
                  <table height="100%" cellpadding="0" cellspacing="0" >
                     <tr>
                        <td class="stdbold" valign="top" align="left"><span style="{color: #962a2a}">${quickSearchUser.userName}</span></td>
                     </tr>

                     <tr>
                        <td colspan="2">${quickSearchUser.maritalStatus}&nbsp;${quickSearchUser.gender} seeking ${quickSearchUser.seekingGender} <BR> was born in ${quickSearchUser.dOByear} <br>from  ${quickSearchUser.city}, ${quickSearchUser.state}, ${quickSearchUser.country} </td>
			<td bgcolor="#FFF1DB" align="right"></td>
                     ...
                     <tr>
                        <td colspan="2">
                           <table width="100%" cellpadding="0" cellspacing="0" > ${quickSearchUser.aboutMe1} <a href="#aboutme">more</a>
                              <tr>
                                 <td class="default"></td>
                              </tr>
                           </table>
                                       ...
                                       <tr>
                                          <td colspan="2">
                                             <table bgcolor="#F8F8F2" width="100%" border="0" cellpadding="0" cellspacing="0" >
                                                <tr>
                                                   <td><a name="aboutme"></a> ${quickSearchUser.aboutMe2} </td>
                                                </tr>
                                             </table>
                                          </td>
                                       </tr>
                                          ...
                                          <td colspan="2">
                                             <table bgcolor="#F8F8F2" width="100%" border="0" cellpadding="0" cellspacing="0" >
                                                <tr>
                                                   ...
                                                   <td width="100%">${quickSearchUser.userName} </td>
                                                </tr>

                                                <tr>
                                                   <td class="std">Gender:</td>
                                                   <td>${quickSearchUser.gender} seeking ${quickSearchUser.seekingGender} </td>
                                                </tr>

                                                <tr>
                                                   <td class="std">From:</td>
                                                   <td> ${quickSearchUser.city}, ${quickSearchUser.state}, ${quickSearchUser.country} </td>
                                                </tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><c:out value="${currentYear-quickSearchUser.dOByear}" /></td>
                                                </tr>
                                             </table>
                                          </td>
                                       </tr>
...
<tr>
   ...
   <td valign="top" width="391">${quickSearchUser.occupationDescription}</td>
</tr>

<tr>
   <td valign="top" class="default" width="159"><span style="{color: #962a2a}">Seeking:</span></td>
   <td valign="top" width="391">${quickSearchUser.relationshipType}</td>
</tr>

<tr>
   <td valign="top" class="default" width="159"><span style="{color: #962a2a}">Headline:</span></td>
   <td valign="top" width="391">${quickSearchUser.headline}</td>
</tr>
</table>
</td>
</tr>
...
<a href="searchUsers.htm" class="stdSmall"><img src="resources/images/btn_close.gif" border="0" align="right"></a></td>
</tr>
</table>
</td>
<td><img src="resources/images/trans.gif" hspace=0 vspace=0 border=0 width=15 height=1></td>
