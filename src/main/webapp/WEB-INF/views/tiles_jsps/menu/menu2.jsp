...
<div id='cssmenu'>
<ul>
   <li><a href='viewMessages.htm?username=${sessionScope.loggedInUser.userName}'>View My Messages</a></li>
   ...
   <li class="active"><a href='changePassword.htm?username=${sessionScope.loggedInUser.userName}'>Change My Password</a></li>
