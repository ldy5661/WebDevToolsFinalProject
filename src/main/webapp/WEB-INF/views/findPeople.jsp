...
<body>
<CENTER>
<form name='lookupByNumberForm' method='post' action='lookupByNumber.htm'>
...
<tr>
   <td width='50%' align='right'><input type='text' name='LookupMemberID' value='' size='18' maxlength='20'><br>
   <font color="red">${requestScope.lookupIDError}</font>
   <font color="red">${requestScope.lookupIDNotValidError}</font>
   </td>
   <td width='50%' align='left'><input type='submit' name='cmdGo1' value='See Profile'></td>
</tr>
</table>
</form>

<form name='lookupByNameForm' method='post' action='lookupByName.htm'>
<p><table width=600 bgcolor='#FFFFEF' border='1' cellpadding='2' cellspacing='4'>
<tr bgcolor='#EFEFCE'>
...
<tr>
   <td width='50%' align='right'><input type='text' name='LookupMemberName' value='' size='18' maxlength='20'><br>
   <font color="red">${requestScope.lookupUserNameError}</font>
   <font color="red">${requestScope.lookupUserNameNotValidError}</font>
   </td>
   <td width='50%' align='left'><input type='submit' name='cmdGo2' value='See Profile'></td>
</tr>
</table>
</form>

<form name='searchUserForm' method='post' action='searchUsers.htm'>
<p><table width=600 bgcolor='#FFFFEF' border='1' cellpadding='2' cellspacing='4'>
<tr bgcolor='#EFEFCE'>
...
<tr>
   ...
   <td width='50%' align='left'>
      ...
      <font color="red">${requestScope.ageError}</font>
      <font color="red">${requestScope.ageNotValidError}</font>
   </td>
</tr>
<tr>
   <td width='50%' align='right'>
...
<select name='CountryRegionID'>
  ...
  <option value='Yugoslavia'          >Yugoslavia</option>
	...
	<option value='Zimbabwe'            >Zimbabwe</option>
         ...
         <tr>
            <td><b>State: </b>
            <td><input type='text' name='stateName' value='' size='18' maxlength='40'><br>
            <font color="red">${requestScope.stateError}</font>
         </tr>
         <tr>
            <td><b>City: </b>
            <td><input type='text' name='cityName' value='' size='18' maxlength='40'><br>
            <font color="red">${requestScope.cityError}</font>
         </tr>
      </table>
   </td>
</tr>
<tr>
   <td colspan='2' align='center'><input type='submit' name='cmdGo3' value='Search'></td>
</tr>
</table>
</form>
</CENTER>
